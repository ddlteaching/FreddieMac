...
7. Stacking ([link](scripts/stacking.py))
8. Boosting ([link](scripts/boosting.py))
...
4. Fitting Random Forests ([link](present/RFFit.html))
5. Boosting ([link](present/boost.html))