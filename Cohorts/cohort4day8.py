...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 12 13:11:40 2017
...
param['eval_metric'] = 'error@0.7'
bst = xgb.train(param, mydtrain, num_boost_round=20, evals = watchlist,early_stopping_rounds=3)
...
xgc = xgb.XGBClassifier(n_estimators = 20)
